...
class TestPaginateData:
    ...
    def test_sorting_ascending(self):
        ...
        result = paginate_data(data, page=1, page_size=10, sort_key=lambda x: x["title"], reverse=False)
    ...
    def test_sorting_descending(self):
        ...
        result = paginate_data(data, page=1, page_size=10, sort_key=lambda x: x["title"], reverse=True)
    ...
    def test_sorting_by_numeric_field(self):
        ...
        data = [{"year": 1999}, {"year": 1972}, {"year": 2008}]
        result = paginate_data(data, page=1, page_size=10, sort_key=lambda x: x["year"], reverse=False)
    ...
    def test_sorting_with_pagination(self):
        ...
        result = paginate_data(data, page=1, page_size=3, sort_key=lambda x: x["year"], reverse=False)
    ...
    def test_sorting_limit_and_pagination(self):
        ...
        result = paginate_data(
            data, limit=4, page=1, page_size=2, sort_key=lambda x: x["rating"], reverse=True  # Take top 4 after sorting
        )
    ...
    def test_case_insensitive_sorting(self):
        ...
        data = [{"title": "apple"}, {"title": "Banana"}, {"title": "cherry"}, {"title": "Apple"}]
        result = paginate_data(data, page=1, page_size=10, sort_key=lambda x: x["title"].lower(), reverse=False)
    ...
    def test_none_values_in_sorting(self):
        ...
        data = [{"year": 2000}, {"year": None}, {"year": 1990}, {"year": None}]
        # Use 0 as default for None values
        result = paginate_data(
            data, page=1, page_size=10, sort_key=lambda x: x["year"] if x["year"] else 0, reverse=False
        )
    ...
    def test_complex_objects(self):
        ...
        result = paginate_data(data, page=1, page_size=2, sort_key=lambda x: x["rating"], reverse=True)
